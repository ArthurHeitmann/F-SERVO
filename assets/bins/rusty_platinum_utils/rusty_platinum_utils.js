...
/**
 * @param {number} wmb_path
 * @returns {number}
 */
export function rpu_load_wmb_from_path(wmb_path) {
    const ret = wasm.rpu_load_wmb_from_path(wmb_path);
    return ret >>> 0;
}
 ...
 * @param {number} name
 * @param {number} wmb
 * @param {number} wmb_size
 * @param {number} wta_wtb
 * @param {number} wta_wtb_size
 * @param {number} wtp
 * @param {number} wtp_size
 * @returns {number}
 */
export function rpu_load_wmb_from_bytes(name, wmb, wmb_size, wta_wtb, wta_wtb_size, wtp, wtp_size) {
    const ret = wasm.rpu_load_wmb_from_bytes(name, wmb, wmb_size, wta_wtb, wta_wtb_size, wtp, wtp_size);
    return ret >>> 0;
}
 ...
 * @returns {number}
 */
export function rpu_new_context() {
    const ret = wasm.rpu_new_context();
    return ret >>> 0;
}
 ...
 * @param {number} width
 * @param {number} height
 * @param {number} scene_data
 * @returns {number}
 */
export function rpu_new_renderer(context, width, height, scene_data) {
    const ret = wasm.rpu_new_renderer(context, width, height, scene_data);
    return ret >>> 0;
}
 ...
 * @param {number} state
 */
export function rpu_drop_renderer(state) {
    wasm.rpu_drop_renderer(state);
}
 ...
 * @returns {number}
 */
export function rpu_render(state, buffer, buffer_size, width, height, bg_r, bg_g, bg_b, bg_a) {
    const ret = wasm.rpu_render(state, buffer, buffer_size, width, height, bg_r, bg_g, bg_b, bg_a);
    return ret;
}
 ...
 * @param {number} y
 */
export function rpu_add_camera_rotation(state, x, y) {
    wasm.rpu_add_camera_rotation(state, x, y);
}
 ...
 * @param {number} y
 */
export function rpu_add_camera_offset(state, x, y) {
    wasm.rpu_add_camera_offset(state, x, y);
}
 ...
 */
export function rpu_zoom_camera_by(state, distance) {
    wasm.rpu_zoom_camera_by(state, distance);
}

/**
 * @param {number} state
 */
export function rpu_auto_set_target(state) {
    wasm.rpu_auto_set_target(state);
}
 ...
 */
export function rpu_set_model_visibility(state, model_id, visibility) {
    wasm.rpu_set_model_visibility(state, model_id, visibility);
}
 ...
 * @returns {number}
 */
export function rpu_get_model_states(state) {
    const ret = wasm.rpu_get_model_states(state);
    return ret >>> 0;
}
...
function __wbg_adapter_33(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h34531c103fe6ffcb(arg0, arg1);
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_closure_wrapper1330 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 459, __wbg_adapter_28);
        return ret;
    };
    ...
    imports.wbg.__wbindgen_closure_wrapper2493 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 905, __wbg_adapter_46);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('rusty_platinum_utils_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();

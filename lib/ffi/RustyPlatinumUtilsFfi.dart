...
class RustyPlatinumUtils {
  ...
  ffi.Pointer<ffi.Void> rpu_load_wmb_from_path(
    ffi.Pointer<ffi.Char> wmb_path,
  ) {
    return _rpu_load_wmb_from_path(
      wmb_path,
    );
  }

  late final _rpu_load_wmb_from_pathPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Void> Function(
              ffi.Pointer<ffi.Char>)>>('rpu_load_wmb_from_path');
  late final _rpu_load_wmb_from_path = _rpu_load_wmb_from_pathPtr
      .asFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Char>)>();

  ffi.Pointer<ffi.Void> rpu_load_wmb_from_bytes(
    ffi.Pointer<ffi.Char> name,
    ffi.Pointer<ffi.Uint8> wmb,
    int wmb_size,
    ffi.Pointer<ffi.Uint8> wta_wtb,
    int wta_wtb_size,
    ffi.Pointer<ffi.Uint8> wtp,
    int wtp_size,
  ) {
    return _rpu_load_wmb_from_bytes(
      name,
      wmb,
      wmb_size,
      wta_wtb,
  ...
  late final _rpu_load_wmb_from_bytesPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Void> Function(
              ...
              ffi.Size,
              ffi.Pointer<ffi.Uint8>,
              ffi.Size)>>('rpu_load_wmb_from_bytes');
  late final _rpu_load_wmb_from_bytes = _rpu_load_wmb_from_bytesPtr.asFunction<
      ffi.Pointer<ffi.Void> Function(
          ffi.Pointer<ffi.Char>,
          ffi.Pointer<ffi.Uint8>,
          int,

...
class __WwiseProjectGeneratorPopupState extends State<_WwiseProjectGeneratorPopup> {
  ...
  void initState() {
    ...
    optStreaming = BoolProp(lastSettings["optStreaming"] as bool? ?? false, fileId: null);
    ...
    optNamePrefix = BoolProp(lastSettings["optNamePrefix"] as bool? ?? false, fileId: null);
    ...
    randomObjId = BoolProp(lastSettings["randomObjId"] as bool? ?? true, fileId: null);
    randomWemId = BoolProp(lastSettings["randomWemId"] as bool? ?? true, fileId: null);

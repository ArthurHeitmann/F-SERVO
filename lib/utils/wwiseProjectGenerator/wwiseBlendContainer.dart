...
class WwiseBlendContainer extends WwiseHierarchyElement<BnkLayerContainer> {
  WwiseBlendContainer({required super.wuId, required super.project, required super.chunk}) : super(
    ...
    name: makeElementName(project, id: chunk.uid, category: "Blend Container", parentId: chunk.baseParams.directParentID, childIds: chunk.childrenList.ulChildIDs, addId: true),
    shortId: chunk.uid,
  );
}
